      ...
      <FadeIn duration={200}>
        <section id="work-experience">
          <div className="space-y-2 ">
            <h1 className="text-4xl font-bold">Here&apos;s where I&apos;ve worked at</h1>
            <WorkExperienceList />
          </div>
        </section>
      </FadeIn>
      ...
      <FadeIn duration={300}>
        <section id="language&tools" className="py-12">
          <div className="space-y-10">
            <div>
              <h1 className="w-fit font-bold text-4xl flex gap-2">A Craftsman & His Tools</h1>
              <p className="text-neutral-700">Technologies and tools I use to build software solutions.</p>
            </div>
